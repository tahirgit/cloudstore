...
class StoreController extends Controller {
   ...
   # - Listing Services
    ...
    public function getComponentById($categoryId, $service) {
        $model = new Cloud;
        return $model->getComponentInfoById($categoryId, $service);
    }
    ...
    public function actionCheckout() {
        ...
        $setup_charges = $request->getPost('setup_charges');
        ...
        if ($request->getPost('pkg_add')) {
            ...
            $customize['Package type']['component_price'] = $request->getPost('pkg_add');
        }
        ...
        if ($request->getPost('number_of_mailbox')) {
            ...
            $customize['Number of Mailbox(s)']['unit_price'] = $request->getPost('mailbox_unit_price');
            $customize['Number of Mailbox(s)']['component_price'] = ( $request->getPost('mailbox_unit_price') * $request->getPost('number_of_mailbox'));
        ...
        if ($request->getPost('drivesVal')) {
            ...
            $customize['Additional Storage']['component_price'] = ( $request->getPost('drive_unit_price') * $request->getPost('drivesVal'));
        }
        ...
        if ($request->getPost('osVal')) {
            ...
            $customize['OS']['component_price'] = $request->getPost('os_unit_price');
        }
        ...
        if ($request->getPost('addstm')) {
            ...
            $customize['Additional Storage per Mailbox']['component_price'] = $request->getPost('addstm_unit_price') * $request->getPost('addstm');
        }
        ...
        if ($request->getPost('addsupport_0')) {
            ...
            $customize['support']['component_price'] = $request->getPost('support_value_0');
        }
        if ($request->getPost('addsupport_1')) {
            ...
            $customize['support']['component_price'] = $request->getPost('support_value_1');
        }
        ...
        if ($request->getPost('addapplication_0')) {
            ...
            $customize['application']['component_price'] = $request->getPost('application_value_0');
        }
        if ($request->getPost('addapplication_1')) {
            ...
            $customize['application']['component_price'] = $request->getPost('application_value_1');
            //echo '<pre>'; print_r($customize); exit;
        }
        if ($request->getPost('addapplication_2')) {
            ...
            $customize['application']['component_price'] = $request->getPost('application_value_2');
            //echo '<pre>'; print_r($customize); exit;
        }
        if ($request->getPost('addapplication_3')) {
            ...
            $customize['application']['component_price'] = $request->getPost('application_value_3');
            //echo '<pre>'; print_r($customize); exit;
        }
        if ($request->getPost('addapplication_4')) {
            ...
            $customize['application']['component_price'] = $request->getPost('application_value_4');
        }
        ...
        if ($request->getPost('addapplication_5')) {
            ...
            $customize['application']['component_price'] = $request->getPost('application_value_5');
            //echo '<pre>'; print_r($customize); exit;
        }
        # mailbox
        ...
        if ($request->getPost('addbackup')) {
            ...
            $customize['data backup']['component_price'] = ( $request->getPost('backup_unit_price') * $request->getPost('addbackup'));
        }
        ...
        # Store All in Cart's tables
        $model = new Store;
        $model->saveOrder($cart_id, $serviceName, $package_type, $package_id, $subtotal, $customizeTotal, $totalAmount, $setup_charges, $customize);
        $this->redirect(array("store/viewCart/"));
    }
